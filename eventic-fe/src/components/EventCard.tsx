...
import { faCalendar, faLocationArrow, faPaperclip, faPerson, faSquarePersonConfined, IconDefinition } from '@fortawesome/free-solid-svg-icons'
...
export function EventCard({ large = false, event }: Props) {
    return (
        <>
